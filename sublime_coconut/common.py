...
##                            File: sublime_coconut/common.coco               ##
##                                                                            ##
...
#-- NUMBERS -------------------------------------------------------------------#
        ...
        0x0050:
        {
            ...
            'match': r'\d[\d_]*\.([\d_]*([eE][+-]?\d[\d_]*)?)?[iIjJ]?(?=\W)(?!\.)'
        },
...
#-- BUILTINS ------------------------------------------------------------------#
        'builtin_exceptions':
        {
            ...
            (
                ...
                r'Runtime|Syntax|Indentation|Tab|System|Type|UnboundLocal|'
