...
#-- BUILTINS ------------------------------------------------------------------#
        ...
        'builtin_functions':
        {
            ...
            (
                ...
                r'addpattern|recursive_iterator|reiterable|scan|groupsof|memoize|fmap|(py_)?breakpoint|override'
                r')\b'
            )
        },
        'builtin_types':
        {
            ...
            (
                ...
                r'property|(py_)?reversed|set|slice|staticmethod|(py_)?str|super|type|'
...
#-- MAGIC STUFFS --------------------------------------------------------------#
        ...
        'magic_function_names':
        {
            ...
            (
                ...
                r'trunc|unicode|weakref|xor|fmap|set_name'
                r')__\b'
            )
        },
